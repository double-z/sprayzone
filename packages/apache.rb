...
package :apache_virtual_host do
  ...
  runner "sudo rm /etc/apache2/sites-available/#{APP_NAME}" # Remove the app virtualhost config...
  push_text virtualhost_content, "/etc/apache2/sites-available/#{APP_NAME}" # ...and replcae it with ours
